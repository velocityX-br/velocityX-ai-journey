#!/usr/bin/env python3
"""Health check script for the Gardener AI MCP server.

Probes the Qdrant /healthz endpoint to verify that the vector store is
reachable from inside the container.  Used by the Docker HEALTHCHECK
instruction and callable manually via kubectl exec.
